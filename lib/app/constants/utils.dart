...
class MyTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        ...
        'fr': {
          'deleteAccountTitle': 'Supprimé',
          'deleteAccountSubtitle': 'Toutes les informations liées à votre compte ont été compromises !',
          'deleteAccount': 'Supprimer le compte',
          'read': 'Lire',
          'product': 'Produit',
          'signInDialog': "Remplissez complètement et correctement les informations de l'utilisateur pour vous connecter",
          'signIn1': 'Votre nom de famille',
          'signIn2': 'Votre prénom',
          'noImage': "Pas d'image",
          'noProductTitle': 'Prêt',
          'noProductSubtitle': 'Pas en stock',
          'kargoIncluded': 'Cargo gratuit',
          'orderComplete': 'Commande confirmée',
          'orderCompletedTrue': 'Votre commande a été confirmée. On vous contactera par téléphone',
          'emptyLocations': 'Vos emplacements ne sont pas inclus',
          'ordersDeleted': 'Vos commandes ont été supprimées',
          'orderName1': 'Attente',
          'orderName2': 'Accepté',
          'orderName3': 'Produit en route',
          'orderName4': 'Rejeté',
          'noHistoryOrders': "Vous n'avez passé aucune commande",
          'sum': 'Total',
          'status': 'Statut',
          'sameProducts': 'Mêmes produits',
          'more': 'Additions',
          'date': 'Année : ',
          'orderDetails': 'Détails',
          'terms_and_conditions_to_order': 'Cher utilisateur, veuillez accepter les conditions de la commande',
          'skip': 'Passer',
          'waitForSms': 'Veuillez attendre le code SMS!',
          'referalDesc': "Avec ce code, vous pouvez attirer des utilisateurs et gagner de l'argent",
          'orderType': 'Type de commande',
          'emptyFavS': 'Votre liste de produits est toujours vide',
          'emptyFavT': "Je n'ai pas de favoris",
          'banner': 'Publicité',
          'errorTitle': 'Erreur',
          'plain': 'Avion',
          'train': 'Camion',
          'container': 'Conteneur',
          'orderComesThatDayTitle': 'La marchandise commandée arrivera dans',
          'orderComesThatDaySubtitle': 'semaines',
          'selectColor': 'Choisissez une couleur!',
          'selectSize': 'Choisissez une taille!',
          'aboutUs': 'A propos de nous',
          'addCart': 'Ajouter au panier',
          'added': 'Ajouté',
          'addedSubtitle': 'Ajouté au panier',
          'agree': 'Confirmation',
          'alreadyExist': "Nous n'avons pas vos données utilisateur. Veuillez vous connecter dans la section Inscription",
          'balance': 'Compte',
          'call': 'Appel',
          'cart': 'Panier',
          'cartEmpty': 'Votre panier est vide',
          'cartEmptySubtitle': "Vous navez rien ajouté au panier",
          'category': 'Catégorie',
          'come': 'Arrivé',
          'contactInformation': 'Contactez :',
          'copySucces': 'Confirmé',
          'countProducts': 'Produits : ',
          'createdAt': 'Date de publication :',
          'data': 'Informations :',
          'data1': 'Nom de la machine à coudre :',
          'data2': 'Catégorie :',
          'data3': 'Nombre de vues :',
          'data4': 'Nombre de téléchargements :',
          'data5': 'Informations supplémentaires :',
          'description': 'Description',
          'download': 'Télécharger',
          'downloaded': 'Mes téléchargements',
          'downloadFiles': 'Télécharger',
          'emptyCart': 'Le panier est vide',
          'emptyCartSubtitle': 'Ajoutez des produits au panier pour commander',
          'error': "Une erreur s'est produite. Veuillez réessayer",
          'errorData': 'Vos données de connexion sont incorrectes!',
          'errorEmpty': 'Le champ de texte ne peut pas être vide',
          'errorPassword': 'Le mot de passe doit contenir au moins 6 caractères',
          'errorPassword2': 'Votre mot de passe est incorrect',
          'errorPhoneCount': 'Votre numéro de téléphone doit comporter 8 chiffres.',
          'favorites': 'Favoris',
          'fixMachine': 'Maintenance',
          'giveLike': 'Évaluez-nous sur Play Market',
          'home': 'Accueil',
          "locations": "Mes adresses",
          "log_out_title": "Voulez-vous vraiment quitter l'application?",
          "log_out": "Sortir",
          "login": "Se connecter",
          "loginError": "Se connecter",
          "loginError1": "Connectez-vous pour effectuer le service",
          "loginErrorSubtitle": "Connectez-vous pour commander",
          "loginErrorSubtitle1": "Connectez-vous pour effectuer le service",
          "maxPrice": "Cher",
          "minPrice": "Pas cher",
          "no": "Non",
          "noConnection1": "Pas de connexion",
          "noConnection2": "Impossible de se connecter à Internet. Veuillez vérifier vos paramètres Internet et réessayer!",
          "noConnection3": "Essayez de nouveau",
          "noData": "Impossible de charger les données. Réessayez.",
          "noData1": "Pas d'information temporaire!",
          "noFile": "Pas de fichier. Contactez-nous",
          "noMoney": "Pas d'argent",
          "noMoneySubtitle": "Vous n'avez pas assez d'argent pour effectuer le service",
          "note": "Remarque",
          "notification": "Notifications",
          "notWork": "Ne fonctionne pas",
          "notWorkSubtitle": "Le service d'alerte ne fonctionne pas",
          "order": "Commande",
          "orderAdress": "Votre adresse de livraison",
          "orderProducts": "Passer une commande",
          "orders": "Mes commandes",
          "orderSubtitle": "Votre commande est placée en file d'attente pour exécution",
          "otp": "Code de sms",
          "otpCheck": "Confirmation OTP",
          "otpErrorSubtitle": "Veuillez vérifier à nouveau votre code sms",
          "otpErrorTitle": "Erreur de code SMS",
          "otpSubtitle": "Entrez le code SMS reçu sur votre téléphone",
          "ourDeliveryService": "Livraison et paiement",
          "phoneNumber": "Votre numéro de téléphone",
          "priceProduct": "Prix final : ",
          "priceRange": "Gamme de prix",
          "productAddToFav": "Produits ajoutés aux favoris",
          "products": "Produits",
          "profil": "Utilisateur",
          "questions": "Des questions ?",
          "select_language": "Choisissez la langue",
          "selectCityTitle": "Sélectionnez la province",
          "selectDate": "Sélectionnez la date de livraison",
          "selectDateTitle": "Heure de livraison de la commande :",
          "selectMachine": "Choisissez le type de machine à coudre",
          "settings": "Paramètres",
          "share": "Partager l'application",
          "shareUs": "Partager l'application",
          "signUp": "S'inscrire",
          "filter": "Filtre",
          "sort": "Trier",
          "sortDefault": "Par défaut",
          "sortCreatedAtHighToLow": "D'abord nouveau",
          "sortCreatedAtLowToHigh": "D'abord vieux",
          "sortPriceHighToLow": "Premier pas cher",
          "sortPriceLowToHigh": "Premières valeurs",
          "sortViewsASC": "Plus de vues",
          "sortViewsDESC": "Moins de vues",
          "termsAndCondition": "Règles et conditions d'utilisation",
          "transferUSB": "Transfert USB",
          ...
          "brandPP": "Marque",
          "brands": "Marques",
          "callNumber": "Nos numéros de téléphone",
          "cash": "Fonds",
          "cashSubtitle": "Paiement en espèces à la réception de la commande",
          "categoriesMini": "Catégories",
          "creditCart": "Carte de crédit",
          "creditCartSubtitle": "Paiement par terminal de paiement à la réception de la commande",
          "deleteFavProduct": "Supprimer mes favoris !",
          "deleteFavProductSubtitle": "Êtes-vous sûr de vouloir supprimer le favori ?",
          "discountedItems": "Articles en solde",
          "recomendedItems": "Produits recommandés",
          "doYouWantToDeleteCart": "Panier vide !",
          "doYouWantToDeleteCartSubtitle": "Êtes-vous sûr de vouloir supprimer le panier?",
          "hastags": "Hashtags",
          "minSumCount": "Malheureusement, le montant de la commande doit être d'au moins 50 manats.",
          "newItems": "Nouveaux articles",
          "orderAgreeSubTitle": "Les Vodas que vous avez commandées sont livrées sous forme de ",
          "orderAgreeTitle": "Confirmer la commande !",
          "orderDeleted": "Supprimé",
          "orderDeletedSubtitle": "Les commandes sont supprimées du panier",
          "paymentMethod": "Mode de paiement ",
          "sameProducts": "Les mêmes produits",
          "search": "Rechercher ",
          "trendingItems": "Articles populaires",
          "userInfo": "Informations sur l'utilisateur :",
          "videos": "Courtes vidéos",
          "shopByBrand": "Recherche par marque",
          "inOurHands": "Vous pourriez aussi aimer ces",
          "price": "Prix :",
          "chooseTheColor": "Choisissez la couleur : ",
          "chooseTheSize": "Taille :",
          "order_status_wait": "Articles commandés",
          "order_status_come": "Arrivée",
          "order_status_submission": "Livré",
          "referal_Code": "Code promo",
          "terms_and_conditions": "Termes et conditions",
          "addAddress": "Ajouter une adresse",
          "address": "Votre adresse à domicile",
          "add": "Ajouter",
          "deleteAddress": "Mon adresse",
          "deleteAddressTitle": "  Êtes-vous sûr d'avoir supprimé toutes les adresses dans l'application ? ",
          "referalKodEarnedMoney": "Revenu total :",
          "referalKodUsedUser": "Utilisateurs utilisant le code",
          "referalKod1": "Votre code de référence",
          "referalKod": "Code promo",
          "copySuccesSubtitle": "Transfert terminé",
          "appColor": "Couleur de l'application",
          "appColor1": "Choisissez la couleur de l'application",
          "appColor2": "Couleur  1",
          "appColor3": "Couleur  2",
          "appColor4": "Couleur  3",
        }
